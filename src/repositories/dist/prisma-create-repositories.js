...
exports.Operacao_no_Banco = void 0;
var prisma_1 = require("@/lib/prisma");
// Class para manipulação directa no banco de dados
var Operacao_no_Banco = /** @class */ (function () {
    function Operacao_no_Banco() {
    }
    /*
  Funçoes do banco
  ----------------------------------------------------------------------------
  ...
  [x] Criar user no banco
    ...
    Operacao_no_Banco.prototype.procurarIdUsuario = function (id) {
    ...
    Operacao_no_Banco.prototype.procurarGmailUsuario = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Operacao_no_Banco.prototype.criar = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return Operacao_no_Banco;
}());
exports.Operacao_no_Banco = Operacao_no_Banco;
