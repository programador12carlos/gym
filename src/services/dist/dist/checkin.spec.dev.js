      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , vitest_1.expect(checkin.gin_id).toEqual(vitest_1.expect.any(String))];
...
vitest_1.it(' NAO DEVERIA SER POSSIVEL FAZER CHECK IN EM UMA ACADEMIA DISTANTE', function () {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
