...
const in_memory_checkin_repositore_1 = require('../repositories/in-memory-checkin-repositore')
const checkin_1 = require('./checkin')
const in_memory_gin_repository_1 = require('@/repositories/in-memory-gin-repository')
...
vitest_1.describe('testando o checkin', function () {
  vitest_1.beforeEach(function () {
    BancoDeDados =
      new in_memory_checkin_repositore_1.InMemoryCheckInRepository()
  ...
  vitest_1.it('DEVE SER POSSIVEL FAZER CHECK IN EM UMA ACADEMIA', function () {
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /* yield */,
              vitest_1
                .expect(checkin.gin_id)
                .toEqual(vitest_1.expect.any(String)),
            ]
          case 3:
            _a.sent()
            return [2 /* return */]
  ...
  vitest_1.it('O USUARIO NAO DEVE SE INCREVER EM DUAS VEZES', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
...
vitest_1.it(
  ' NAO DEVERIA SER POSSIVEL FAZER CHECK IN EM UMA ACADEMIA DISTANTE',
  function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
